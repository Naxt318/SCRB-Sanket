...
// Firebase Auth (client SDK) — this just maps a signed-in email to the SCRB
// profile info (role, district, badge) the UI needs.
//
// Keep the emails here in sync with `@/lib/demo-users.ts` (used by the
// login page's account picker).
//
